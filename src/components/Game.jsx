...
const Game = () => {
  ...
  const shuffle = (randomWordOne, randomWordTwo) => {
    ...
    const shuffledWord = shuffledLetters
      .join("")
      .toUpperCase()
      .replace(/\s/g, "");
  ...
  return (
    <div className="bg-gray-800">
      <div className="border border-red-800">
        ...
        <div>
          <h1 className="poppins text-gray-300 font-bold text-l">
            {shuffledWord}
          </h1>
        </div>
        ...
        <div className={!displayAnswer ? "hidden" : "p2"}>
          {!gameMode ? (
            ...
            <h1 className="text-gray-300 font-bold poppins">
              {wordOne.name} {wordTwo.name}
            </h1>
          )}
        </div>
      </div>
